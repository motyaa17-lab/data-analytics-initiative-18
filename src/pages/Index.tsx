      ...
      <nav className="bg-[#2f3136] border-b border-[#202225] px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">GamerZone</h1>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          >
            <div className="p-4 border-b border-[#202225] flex items-center justify-between">
              <h2 className="text-white font-semibold text-base">GamerZone</h2>
              <Button
                variant="ghost"
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["общий", "лайфхаки", "обзоры", "поиск-тиммейтов"].map((channel) => (
                    <div
                      key={channel}
              ...
              <div>
                ...
                <div className="mt-1 space-y-0.5">
                  {["Общий лобби", "Ranked Squad"].map((channel) => (
                    <div
                      key={channel}
                      className="flex items-center gap-1.5 px-2 py-1 rounded text-[#8e9297] hover:text-[#dcddde] hover:bg-[#393c43] cursor-pointer"
                    >
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Общайся, играй, побеждай вместе</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">GamerZone Бот</span>
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Добро пожаловать в GamerZone!</strong> Соцсеть, где геймеры находят тиммейтов, делятся клипами и соревнуются в рейтингах.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что тебя ждёт на GamerZone:</h3>
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        <li>🎮 Профиль геймера с историей матчей и статистикой</li>
                        <li>🤝 Поиск тиммейтов по игре, рангу и времени</li>
                        <li>🏆 Турниры и челленджи каждую неделю</li>
                        <li>📹 Делись своими лучшими клипами и хайлайтами</li>
                        <li>💬 Голосовые комнаты для игры с друзьями</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    ...
                    <span className="bg-[#faa61a] text-[#111] text-xs px-1 rounded font-semibold">Легенда</span>
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Только что взял топ-1 в Warzone! Ищу сквад для рейтинговых игр 🔥
                  </div>

                  {/* Карточка профиля геймера */}
                    ...
                    <div className="pt-4 sm:pt-6 px-3 sm:px-4 pb-3 sm:pb-4">
                      <div className="mb-3 sm:mb-4">
                        ...
                        <div className="flex items-center gap-2 text-[#b9bbbe] text-xs sm:text-sm">
                          <span>shadow#7777</span>
                          <span>-</span>
                          <span>Sniper Main</span>
                          <div className="flex gap-1 ml-2">
                            ...
                            <div className="w-3 h-3 sm:w-4 sm:h-4 bg-[#eb459e] rounded-sm"></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mb-3 sm:mb-4">
                        <div className="bg-[#36393f] rounded-lg p-2 sm:p-3 relative">
                          ...
                          <div className="flex items-center gap-2 text-[#dcddde] text-xs sm:text-sm">
                            <span>🏆</span>
                            <span>Ищу сквад на ранкед — пишите!</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#ff7262] to-[#f24e1e] rounded-lg flex items-center justify-center flex-shrink-0 text-2xl">
                            🎮
                          </div>
                          <div className="flex-1 min-w-0">
                            <div className="text-white font-semibold text-xs sm:text-sm mb-1">Warzone 2.0</div>
                            <div className="text-[#dcddde] text-xs sm:text-sm mb-1">Рейтинговый матч • Топ-5</div>
                            <div className="text-[#b9bbbe] text-xs sm:text-sm mb-2">K/D: 4.2 • Побед: 847</div>
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-[#3ba55c] rounded-full animate-pulse"></div>
                              <span className="text-[#3ba55c] text-xs font-medium">В игре • 42 мин</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Наконец-то соцсеть именно для нас! Больше не надо объяснять маме что такое K/D 😂
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-white font-medium mb-2 text-sm sm:text-base">Создай профиль</h3>
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Укажи игры, ранг и любимый стиль игры</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold text-sm sm:text-base">2</span>
                    </div>
                    <h3 className="text-white font-medium mb-2 text-sm sm:text-base">Найди сквад</h3>
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Смартматч подберёт тиммейтов по уровню</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold text-sm sm:text-base">3</span>
                    </div>
                    <h3 className="text-white font-medium mb-2 text-sm sm:text-base">Побеждай вместе</h3>
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Участвуй в турнирах и попади в топ</p>
                  </div>
                </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Почему GamerZone?</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    {
                      icon: <Zap className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Смартматч",
                      desc: "Находит тиммейтов за секунды по рангу и игре",
                    },
                    {
                      icon: <Eye className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Live-статус",
                      desc: "Видно кто сейчас онлайн и во что играет",
                    },
                    {
                      icon: <Clock className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "История матчей",
                      desc: "Полная статистика по всем сыгранным играм",
                    },
                    {
                      icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Антитоксик",
                      desc: "Репутационная система и модерация",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
